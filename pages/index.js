            ...
            <div className="text-center">
              <div className="relative mx-auto w-48 h-48 mb-6 rounded-2xl bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden">
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-400">Step 1 Image Placeholder</p>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-slate-100 to-slate-200 aspect-square flex items-center justify-center border border-slate-200">
                <div className="text-center">
                  ...
                  <p className="text-sm font-medium text-slate-500">Feature Illustration Placeholder</p>
                  <p className="text-xs text-slate-400 mt-1">Generate: Confused person with insurance papers</p>
                </div>
              </div>
            </div>
          </div>
